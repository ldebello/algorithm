...
image::http://g.gravizo.com/g?graph%20G%20{%201%20--%204[label="5"];%201%20--%202[label="2"];%202%20--%203[label="14"];%203%20--%205[label="34"];%202%20--%205[label="4"];%202%20--%204[label="5"];%204%20--%205[label="58"];}["Data"]
